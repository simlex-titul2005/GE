...
namespace GE.WebAdmin.Controllers
{
    ...
    public partial class T4MVC_ArticleTypesController : GE.WebAdmin.Controllers.ArticleTypesController
    {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_PartialViewResult callInfo, GE.WebAdmin.Models.VMArticleType filterModel, System.Collections.Generic.IDictionary<string, SX.WebCore.HtmlHelpers.SxExtantions.SortDirection> order, int page);

        [NonAction]
        public override System.Web.Mvc.PartialViewResult Index(GE.WebAdmin.Models.VMArticleType filterModel, System.Collections.Generic.IDictionary<string, SX.WebCore.HtmlHelpers.SxExtantions.SortDirection> order, int page)
        {
        ...
        [NonAction]
        partial void DeleteOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, GE.WebAdmin.Models.VMEditArticleType model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Delete(GE.WebAdmin.Models.VMEditArticleType model)
        {
