...
namespace GE.WebUI.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SiteTestsController : GE.WebUI.Controllers.SiteTestsController
    {
        public T4MVC_SiteTestsController() : base(Dummy.Instance) { }

        [NonAction]
        partial void RandomListOverride(T4MVC_System_Web_Mvc_PartialViewResult callInfo);

        [NonAction]
        public override System.Web.Mvc.PartialViewResult RandomList()
        {
