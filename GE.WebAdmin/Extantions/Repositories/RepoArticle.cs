...
namespace GE.WebAdmin.Extantions.Repositories
{
    ...
    {
        public static Article GetByTitleUrl(this RepoArticle<SxVMMaterial> repo, string titleUrl)
        {
...
WHERE dm.TitleUrl=@TITLE_URL";
        ...
        public static VMArticle[] QueryForAdmin(this RepoArticle<SxVMMaterial> repo, SxFilter filter)
        {
        ...
        public static int FilterCount(this RepoArticle<SxVMMaterial> repo, SxFilter filter)
        {
