...
namespace GE.WebUI.Controllers
{
    public partial class SearchController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Search = "~/Views/Search/_Search.cshtml";
            public readonly string List = "~/Views/Search/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SearchController : GE.WebUI.Controllers.SearchController
    {
        public T4MVC_SearchController() : base(Dummy.Instance) { }

        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string key);

        [NonAction]
        public override System.Web.Mvc.ActionResult List(string key)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.List);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "key", key);
            ListOverride(callInfo, key);
            return callInfo;
        }
