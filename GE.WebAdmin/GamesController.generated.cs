...
namespace GE.WebAdmin.Controllers
{
    public partial class GamesController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string _FindGridView = "~/Views/Games/_FindGridView.cshtml";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_GamesController : GE.WebAdmin.Controllers.GamesController
    {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_PartialViewResult callInfo, GE.WebAdmin.Models.VMGame filterModel, System.Collections.Generic.IDictionary<string, SX.WebCore.HtmlHelpers.SxExtantions.SortDirection> order, int page);

        [NonAction]
        public override System.Web.Mvc.PartialViewResult Index(GE.WebAdmin.Models.VMGame filterModel, System.Collections.Generic.IDictionary<string, SX.WebCore.HtmlHelpers.SxExtantions.SortDirection> order, int page)
        {
        ...
        [NonAction]
        partial void FindGridViewOverride(T4MVC_System_Web_Mvc_PartialViewResult callInfo, GE.WebAdmin.Models.VMGame filterModel, int page, int pageSize);

        [NonAction]
        public override System.Web.Mvc.PartialViewResult FindGridView(GE.WebAdmin.Models.VMGame filterModel, int page, int pageSize)
        {
