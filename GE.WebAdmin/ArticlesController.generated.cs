...
namespace GE.WebAdmin.Controllers
{
    public partial class ArticlesController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Edit = "~/Views/Articles/Edit.cshtml";
            public readonly string Index = "~/Views/Articles/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ArticlesController : GE.WebAdmin.Controllers.ArticlesController
    {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_PartialViewResult callInfo, GE.WebAdmin.Models.VMArticle filterModel, System.Collections.Generic.IDictionary<string, SX.WebCore.HtmlHelpers.SxExtantions.SortDirection> order, int page);

        [NonAction]
        public override System.Web.Mvc.PartialViewResult Index(GE.WebAdmin.Models.VMArticle filterModel, System.Collections.Generic.IDictionary<string, SX.WebCore.HtmlHelpers.SxExtantions.SortDirection> order, int page)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, GE.WebAdmin.Models.VMEditArticle model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(GE.WebAdmin.Models.VMEditArticle model)
        {
        ...
        [NonAction]
        partial void DeleteOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, GE.WebAdmin.Models.VMEditNews model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Delete(GE.WebAdmin.Models.VMEditNews model)
        {
