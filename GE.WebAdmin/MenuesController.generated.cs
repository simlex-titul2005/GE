...
namespace GE.WebAdmin.Controllers
{
    public partial class MenuesController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string _GridView = "~/Views/Menues/_GridView.cshtml";
            public readonly string Edit = "~/Views/Menues/Edit.cshtml";
            public readonly string Index = "~/Views/Menues/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_MenuesController : GE.WebAdmin.Controllers.MenuesController
    {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_PartialViewResult callInfo, GE.WebAdmin.Models.VMMenu filterModel, System.Collections.Generic.IDictionary<string, SX.WebCore.HtmlHelpers.SxExtantions.SortDirection> order, int page);

        [NonAction]
        public override System.Web.Mvc.PartialViewResult Index(GE.WebAdmin.Models.VMMenu filterModel, System.Collections.Generic.IDictionary<string, SX.WebCore.HtmlHelpers.SxExtantions.SortDirection> order, int page)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, GE.WebAdmin.Models.VMEditMenu model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(GE.WebAdmin.Models.VMEditMenu model)
        {
