...
namespace SX.WebCore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public virtual async Task<ActionResult> Login(SxVMLogin model, string returnUrl)
        {
        ...
        public virtual async Task<ActionResult> VerifyCode(string provider, string returnUrl, bool rememberMe)
        {
            ...
            return View(new SxVMVerifyCode { Provider = provider, ReturnUrl = returnUrl, RememberMe = rememberMe });
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public virtual async Task<ActionResult> VerifyCode(SxVMVerifyCode model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public virtual async Task<ActionResult> Register(SxVMRegister model)
        {
            if (ModelState.IsValid)
            {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public virtual async Task<ActionResult> ForgotPassword(SxVMForgotPassword model)
        {
            if (ModelState.IsValid)
            {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public virtual async Task<ActionResult> ResetPassword(SxVMResetPassword model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
        ...
        public virtual async Task<ActionResult> SendCode(string returnUrl, bool rememberMe)
        {
            ...
            return View(new SxVMSendCode { Providers = factorOptions, ReturnUrl = returnUrl, RememberMe = rememberMe });
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public virtual async Task<ActionResult> SendCode(SxVMSendCode model)
        {
            if (!ModelState.IsValid)
            {
                return View();
        ...
        public virtual async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    return View("ExternalLoginConfirmation", new SxVMExternalLoginConfirmation { Email = loginInfo.Email });
            }
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public virtual async Task<ActionResult> ExternalLoginConfirmation(SxVMExternalLoginConfirmation model, string returnUrl)
        {
