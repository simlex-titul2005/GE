...
function sendUserClick(c,s,t){$.ajax({method:"post",url:"/userclicks/click",data:{mid:c,mct:s,uct:t},success:function(c){return c}})}
function bannerClick(e){$.ajax({method:"post",url:"/banners/addclick",data:{bannerId:e}})}function changeLocation(e){var a=$(e).find("a").attr("href");window.location=a}function loadScriptOnce(e){for(var a=document.getElementsByTagName("script"),r=a.length,n=!1;r--;)a[r].src==e&&(n=!0);if(!n){var t=document.createElement("script");t.src=e;var o=document.getElementsByTagName("script")[0];o.parentNode.insertBefore(t,o)}}function onPlayerReady(e){players[0]&&(players[0].stopVideo(),players.splice(0,1)),players.push(e.target),players[0].playVideo()}function playVideoById(e,a){player=new YT.Player(e,{videoId:a,events:{onReady:onPlayerReady}})}function resizeFooter(){var e=$("footer"),a=e.height();e.css({position:"absolute"}),$("body").css("margin-bottom",a+"px")}jQuery.fn.swap=function(e){e=jQuery(e)[0];var a=this[0];if(a!==e){var r=a.cloneNode(!0),n=e.cloneNode(!0),t=this;return a.parentNode.replaceChild(n,a),e.parentNode.replaceChild(r,e),t[0]=r,this.pushStack(t)}};var players=new Array,player;