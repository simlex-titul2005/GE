...
{
    public partial class SiteTestsController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected SiteTestsController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "SiteTests";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "SiteTests";
        [GeneratedCode("T4MVC", "2.0")]
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SiteTestsController : GE.WebAdmin.Controllers.SiteTestsController
    {
        public T4MVC_SiteTestsController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_PartialViewResult callInfo, GE.WebAdmin.Models.VMSiteTest filterModel, System.Collections.Generic.IDictionary<string, SX.WebCore.HtmlHelpers.SxExtantions.SortDirection> order, int page);

        [NonAction]
        public override System.Web.Mvc.PartialViewResult Index(GE.WebAdmin.Models.VMSiteTest filterModel, System.Collections.Generic.IDictionary<string, SX.WebCore.HtmlHelpers.SxExtantions.SortDirection> order, int page)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, GE.WebAdmin.Models.VMEditSiteTest model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(GE.WebAdmin.Models.VMEditSiteTest model)
        {
        ...
        [NonAction]
        partial void DeleteOverride(T4MVC_System_Web_Mvc_RedirectToRouteResult callInfo, GE.WebAdmin.Models.VMEditSiteTest model);

        [NonAction]
        public override System.Web.Mvc.RedirectToRouteResult Delete(GE.WebAdmin.Models.VMEditSiteTest model)
        {
