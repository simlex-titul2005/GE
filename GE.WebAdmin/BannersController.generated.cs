...
{
    public partial class BannersController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected BannersController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Banners";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Banners";
        [GeneratedCode("T4MVC", "2.0")]
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_BannersController : GE.WebAdmin.Controllers.BannersController
    {
        public T4MVC_BannersController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_PartialViewResult callInfo, GE.WebAdmin.Models.VMBanner filterModel, System.Collections.Generic.IDictionary<string, SX.WebCore.HtmlHelpers.SxExtantions.SortDirection> order, int page);

        [NonAction]
        public override System.Web.Mvc.PartialViewResult Index(GE.WebAdmin.Models.VMBanner filterModel, System.Collections.Generic.IDictionary<string, SX.WebCore.HtmlHelpers.SxExtantions.SortDirection> order, int page)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, GE.WebAdmin.Models.VMEditBanner model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(GE.WebAdmin.Models.VMEditBanner model)
        {
        ...
        [NonAction]
        partial void DeleteOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, GE.WebAdmin.Models.VMEditBanner model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Delete(GE.WebAdmin.Models.VMEditBanner model)
        {
